...
public class CalculatorEngine implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		// Получить число из дисплея калькулятора, если он не пустой
			...
			// и очистить дислпей для ввода нового числа
			...
			if (src == parent.buttonPlus){
				...
				// обновить переменную currentResult и показать результата на дисплее
				
				if (selectedAction == '+'){
					currentResult += displayValue;
					
				// Сконвертировать результата в строку, добавить его к пустой строке и показать
				...
				parent.displayField.setText("" + currentResult);
					...
					// Для всех цифровых кнопок присоеденить надпись на кнопке и надпись на дислее
